...
const response = await fetch("./atbildes.json");
...
function checkHandler(quest, answ, qnum) {
  ...
  console.log(answer);
  let answParent = answer.parentNode
  answParent = answParent.parentNode
  console.log(answParent);

  console.log(answParent.children);
